...
interface = pygame.image.load('survive-covid/Imagens/fundo.jpg')

gameover = pygame.image.load('survive-covid/Imagens/gameover.png')

play = pygame.font.Font("freesansbold.ttf", 20)
...
def play_text():
    play_text = play.render("v1.1.1", True, preto)
    screen.blit(play_text, (730, 560))
...
def start_interface():
    while True:
        ...
        button1 = pygame.Rect(290, 240, 220, 65)

        button2 = pygame.Rect(290, 350, 220, 65)
...
def comandos():
    while True:
        ...
        comandos = pygame.image.load('survive-covid/Imagens/comandos.jpg')

        screen.blit(comandos, (0, 0))

        x,y = pygame.mouse.get_pos()
        button1 = pygame.Rect(25, 25, 120, 70)
