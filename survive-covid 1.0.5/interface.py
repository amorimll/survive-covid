...
interface = pygame.image.load('survive-covid 1.0.5/Imagens/interface.png')

gameover = pygame.image.load('survive-covid 1.0.5/Imagens/gameover.png')
...
#Loop para iniciar o aplicativo.
    ...
    mixer.music.load('survive-covid 1.0.5/Sons/ambiente1.mp3')
    mixer.music.play()
      
    coleta = pygame.mixer.Sound('survive-covid 1.0.5/Sons/wav/bleep.wav')
    virus = pygame.mixer.Sound('survive-covid 1.0.5/Sons/wav/derrota1.wav')
    derrotaMenu = pygame.mixer.Sound('survive-covid 1.0.5/Sons/wav/derrota2.wav')
    ...
    def show_power(x,y):
        power = font.render("Poder: ", True, branco)
        screen.blit(power, (x, y))

    #Função que adiciona a vida no aplicativo.

    def show_vida(x, y):
        vida = font.render("Vida: ", True, (255, 255, 255))
    ...
    while True:
        ...
        pygame.draw.rect(background, branco, (125, 57, power_value, 20))
