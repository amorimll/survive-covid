...
while running:
    ...
    if itemEscolhido == "feijao":

        feijao(feijaoX, feijaoY)
        collisionFeijao = isCollisionFeijao(playerX, playerY, feijaoX, feijaoY)
        if collisionFeijao:
    ...
    if itemEscolhido == "covid":

        covid(covidX, covidY)
        collisionCovid = isCollisionCovid(playerX, playerY, covidX, covidY)
        if collisionCovid:
    ...
    if itemEscolhido == "arroz":

        arroz(arrozX, arrozY)
        collisionArroz = isCollisionArroz(playerX, playerY, arrozX, arrozY)
        if collisionArroz:
    ...
    if itemEscolhido == "gel":
        
        gel(gelX, gelY)
        collisionGel = isCollisionGel(playerX, playerY, gelX, gelY)
        if collisionGel:
